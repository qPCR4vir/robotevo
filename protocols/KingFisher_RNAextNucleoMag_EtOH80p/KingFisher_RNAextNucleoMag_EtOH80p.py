...
class KingFisher_RNAextNucleoMag_EtOH80p(Evo100_FLI):
    ...
    def Run(self):
        ...
        Itr.comment('Extracting RNA from {:s} samples with the original MN-Vet kit protocol and EtOH prefill'.format(
        ...
        Itr.set_DITI_Counter2(DiTi1000_1, posInRack=self.firstTip).exec()
