...
def init_RNAextraction():
    ...
    TeMg_Heat       = Lab.Labware(Lab.TeMag48,      Lab.WorkTable.Location(14, 1), "48 Pos Heat")
    TeMag           = Lab.Labware(Lab.TeMag48,      Lab.WorkTable.Location(14, 2), "48PosMagnet")
    WashCleanerS    = Lab.Cuvette(Lab.CleanerSWS,   Lab.WorkTable.Location(22, 1), "Washstation 2Grid Cleaner short")
    WashWaste       = Lab.Cuvette(Lab.WasteWS,      Lab.WorkTable.Location(22, 2), "Washstation 2Grid Waste")
    WashCleanerL    = Lab.Cuvette(Lab.CleanerLWS,   Lab.WorkTable.Location(22, 3), "Washstation 2Grid Cleaner long")
    DiTiWaste       = Lab.DITIwaste(Lab.DiTi_Waste, Lab.WorkTable.Location(22, 7), "Washstation 2Grid DiTi Waste")
    ...
    ElutBuf       = Lab.Cuvette(Lab.Trough_100ml, Lab.WorkTable.Location(6, 1), "1-VEL-ElutionBuffer" )
    LysBuf        = Lab.Cuvette(Lab.Trough_100ml, Lab.WorkTable.Location(6, 2), "2-Vl Lysis Buffer"   )
    BindBuf       = Lab.Cuvette(Lab.Trough_100ml, Lab.WorkTable.Location(6, 3), "3-VEB Binding Buffer")

    BioWaste      = Lab.Cuvette(Lab.Trough_100ml, Lab.WorkTable.Location(22,6), "6-Waste"             )
    Unused8       = Lab.Cuvette(Lab.Trough_100ml, Lab.WorkTable.Location(24,2), "8-Unused"           )
    Unused9       = Lab.Cuvette(Lab.Trough_100ml, Lab.WorkTable.Location(24,3), "9-Unused"           )

    DiTi1000_1    = Lab.DITIrack(Lab.DiTi_1000ul, Lab.WorkTable.Location(25,1),"1000-1")
    DiTi1000_2    = Lab.DITIrack(Lab.DiTi_1000ul, Lab.WorkTable.Location(25,2),"1000-2")
    DiTi1000_3    = Lab.DITIrack(Lab.DiTi_1000ul, Lab.WorkTable.Location(25,3),"1000-3")

    Reactives = Lab.Labware(Lab.GreinRack16_2mL, Lab.WorkTable.Location(7, 1), "Reactives")
    Eluat     = Lab.Labware(Lab.EppRack3x16R,    Lab.WorkTable.Location(8, 1), "Eluat")
    Samples   = Lab.Labware(Lab.EppRack3x16,     Lab.WorkTable.Location(11,1), "Proben")
