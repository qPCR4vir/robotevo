...
class App(tkinter.Frame):
    ...
    class GUI_protocol(tkinter.Frame):
        def __init__(self, protocol_name, master=None):
            ...
            self.parameters = self.GUIprot.new_parameters(protocol_name, self)
        ...
        def CheckList(self, protocol):
            ...
            self.ReactFrames = [App.GUI_protocol.ReactiveFrame(self, react) for react in protocol.Reactives]
